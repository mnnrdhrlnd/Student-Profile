  ...
  <body>
    ...
    <section id="intro" style="background: url(img/rtu.jpg) center center no-repeat; background-size: cover;" class="intro-section pb-2">
      <div class="container text-center">
        ...
        <div id="one">
        <img src="kuku.jpg" alt="Avatar" style="width:200px"><br></div>
        <button onclick="document.getElementById('id01').style.display='block'"style="width:auto;" class="btn btn-outline-light link-scroll">Login</button>
          ...
          <H1 data-animate="slideInUp" class="h2 text-shadow text-400">Tuazon Nhervyn</h1>
      ...
      <div class="container">
        ...
        <div class="row">
          <div data-animate="fadeInUp" class="col-lg-6">
                  <p>This is my homepage, so I have to say something about myself. Sometimes it is hard to introduce yourself because you know yourself so well that you do not know where to start with. Let me give a try to see what kind of image you have about me through my self-description. I hope that my impression about myself and your impression about me are not so different. Here it goes..</p>
            <p>I always wanted to be a great programmer, like Guido van Rossum the creator of "Python programming language", or like Alan Turing the creator "Turing Machine". They have influenced millions of people through their works.Of course, I am nowhere close to these people, yet. I am just someone who does some coding, some research, and some writing. But my dream is still alive.</p>

            <p>This is a brief introduction of myself. If you are interested in knowing more, take a look at my pictures. Do not expect too much, and keep your sense of humor.
          </div>
          <div data-animate="fadeInUp" class="col-lg-6">
          ...
          <div data-animate="fadeInUp" class="col-sm-6 mx-auto mt-5"><img src="img/about4.jpg" alt="This is me - Porfolio" class="image rounded-circle img-fluid"></div>
          <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>(IT Student)</b><br>I always wanted to be a great programmer, like Guido van Rossum the creator of "Python programming language", or like Alan Turing the creator "Turing Machine". 
They have influenced millions of people through their works.
Of course, I am nowhere close to these people, yet. I am just someone who does some coding, some research, and some writing. But my dream is still alive.</p>
        </div>
      </div>
    </section>
    <!-- Service-->
