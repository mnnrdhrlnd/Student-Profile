  ...
  <body>
    ...
    <section id="intro" style="background: url(img/rtu.jpg) center center no-repeat; background-size: cover;" class="intro-section pb-2">
      <div class="container text-center">
        ...
        <div id="one">
          <img src="junmar.jpg" alt="Avatar" style="width:200px"><br></div>
        <button onclick="document.getElementById('id01').style.display='block'"style="width:auto;" class="btn btn-outline-light link-scroll">Login</button>
          ...
          <H1 data-animate="slideInUp" class="h2 text-shadow text-400">Horlanda Mennard</h1>
      ...
      <div class="container">
        ...
        <div class="row">
          <div data-animate="fadeInUp" class="col-lg-6">
            <p>Hi! I am <b>Mennard N. Horlanda, and Welcome to my Digital Portfolio!</b> 
The goal of this project is to showcase my knowledge and finished outputs in the span of our semester. At the present, I am taking up my bachelor's degree in Information Technology in my third year in the university of gold and blue, the Rizal Technological University Boni Campus.</p>
            <p>This University hones me to become a better version of myself. A great example of it is my computer language programming skills wherein I am always having a rough time cathcing up. Up to this date I can say that I have come so far and learning languages such as <b>Java, JavaScript,CSS, PHP, HTML, Visual Basic,</b> and <b>C++</b> will surelly help me in the future.</p>
          ...
          <div data-animate="fadeInUp" class="col-sm-6 mx-auto mt-5"><img src="img/about1.jpg" alt="This is me - Porfolio" class="image rounded-circle img-fluid"></div>
      ...
      <div class="container">
        ...
        <div class="row services text-center">
          <div data-animate="fadeInUp" class="col-lg-4">
            ...
            <p class="text-left description">s of Today, Cloud Computing really caught my eyes and now I am currently learning about it. Cloud Computing is the real deal in the future so it will help me to boost my knowledge and to become a good and responsible IT Professional.
</p>
          </div>
          <div data-animate="fadeInUp" class="col-lg-4">
            <div class="icon"><i class="fa fa-html5"></i></div>
            <h3 class="heading mb-3 text-400">HTML coding</h3>
            <p class="text-left description">Python is one of the most intersting language for me because it's easier to understand and code. And this language is widely used up to today so it really caught my eyes and continue to learn different languages such as this one.
</p>
          </div>
          <div data-animate="fadeInUp" class="col-lg-4">
            <div class="icon"><i class="fa fa-tachometer"></i></div>
            <h3 class="heading mb-3 text-400">PHP webdelopment</h3>
            <p class="text-left description">These languages focus more on Web Deveopment and these languages are fun to study due to the complexity and the vastness of what you can do to be able to produce a good quality website. Designs that can feed your eyes for once in a while is a really good treat especially for an aspiring IT Professional..</p>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <ul data-animate="fadeInUp" class="owl-carousel owl-theme testimonials equalize-height">
          ...
          <li class="item">
            <div class="testimonial full-height">
              <div class="text">
                <p>Great job! webssite well done!</p>
              </div>
              <div class="bottom">
                <div class="icon"><i class="fa fa-quote-left"></i></div>
