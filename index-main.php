  ...
  <body>
    ...
    <section id="intro" style="background: url(img/rtu.jpg) center center no-repeat; background-size: cover;" class="intro-section pb-2">
      <div class="container text-center">
        ...
        <h1 data-animate="fadeInDown" class="text-shadow mb-5">Digital Portfolio </h1><br>
      ...
      <div class="container">
        ...
        <div class="row">
          <div data-animate="fadeInUp" class="col-lg-6">
            <p>My Name is Danilo Jr Venida, I am currently taking up my  <strong>3rd year in Rizal Technological University</strong>. I created this Digital Portfolio to show what I have done in this whole semester. I will showcase my Projects and Works in here.</p>
            <p>And this is my current status and skills in some of the computer languages that I have learned so far, this are <strong>PHP, CSS and Java Script.</strong> I added a Progressive bar to tell my skill level in particular to that specific language.</p>

            <p>I am looking forward to learn more skills that is needed in my field of profession <strong>(IT)</strong> .And in this subject I realized that using database has a big role in this industry. I hope that i could learn more and use it in the future.</p>
          </div>
          <div data-animate="fadeInUp" class="col-lg-6">
          ...
          <div data-animate="fadeInUp" class="col-sm-6 mx-auto mt-5"><img src="img/about.jpg" alt="This is me - Porfolio" class="image rounded-circle img-fluid"></div>
          <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>(IT Student)</b><br>I was drawn to this career because I think I have the  proclivity for those skills from a young age. I enjoyed math and science- so when I began using a computer I naturally became interested in learning how it worked. I developed basic computer skills and I yearned to learn more- so I focused on code programming in college. As I further developed my abilities- I decided to pursue a career in the field.</p>
        </div>
      </div>
    </section>
    <!-- Service-->
