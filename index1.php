  ...
  <body>
    ...
    <section id="intro" style="background: url(img/home.jpg) center center no-repeat; background-size: cover;" class="intro-section pb-2">
      <div class="container text-center">
        ...
        <h1 data-animate="fadeInDown" class="text-shadow mb-5">My Digital Portfolio </h1>
        <p data-animate="slideInUp" class="h2 text-shadow text-400">Venida,Danilo Jr.</p>
        <p><a href="http://localhost/activities/Project%20shit/sample.html" class="btn btn-outline-light link-scroll">Admin</a>
      ...
      <div class="container">
        ...
        <div class="row">
          <div data-animate="fadeInUp" class="col-lg-6">
            ...
            <p>This is my current status and skills in some of the computer languages that I have learned so far, this are <strong>PHP, CSS and Java Script.</strong> I added a Progressive bar to tell my skill level in particular to that specific language.</p>

            <p>I am looking forward to learn more skills that is needed in my field of profession.<strong>(IT)</strong>.And in this subject I realized that using databse has a big role in this industry. I hope that i could learn more and use it in the future.</p>
          </div>
          <div data-animate="fadeInUp" class="col-lg-6">
